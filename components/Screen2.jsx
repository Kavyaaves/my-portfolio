...
const Screen2 = () => {
    return <div className="h-screen relative bg-light snap-start snap-always">
        <div className="-mt-4">
            <div className='max-w-5xl h-100 flex items-center h-auto lg:h-auto flex-wrap mx-auto lg:my-0'>
                ...
                <ol className="relative p-10">
                    <li className="pb-10 pl-6">
                        <span className="flex absolute left-3 justify-center items-center w-6 h-6 bg-blue-200 rounded-full ring-8 ring-white">
                            <img className="rounded-full shadow-lg" src="/kavy1.jpg" alt="Bonnie image" />
                        </span>
